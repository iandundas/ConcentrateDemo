...
/**
  ...
  For example, to register a table view delegate do: \code
  tableView.protocolProxyFor(UITableViewDelegate.self, setter: NSSelectorFromString("setDelegate:"))
  \endcode.
  ...
  whose instance you’ll set to \code
  forwardTo
  \endcode property.
*/
- (ProtocolProxy * _Nonnull)protocolProxyFor:(Protocol * _Nonnull)protocol setter:(SEL _Nonnull)setter;
@end
...
- (BOOL)hasHandlerForSelector:(SEL _Nonnull)selector;
...
- (BOOL)conformsToProtocol:(Protocol * _Nonnull)aProtocol;
...
@interface UIBarButtonItem (SWIFT_EXTENSION(Bond))
@end
...
@interface UIStepper (SWIFT_EXTENSION(Bond))
@end
